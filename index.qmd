...
```{r}
#| fig-align: center
include_graphics("img/slides.png")
```
...
```{r}
#| fig-align: center
include_graphics("img/file-organization.jpg")
```
...
```{r}
#| fig-align: center
include_graphics("img/version-control.png")
```
...
```{r}
#| fig-align: center
#| fig-cap: Diff due to upgrading R from 3.5.3 to 4.1.0
include_graphics("img/git-diff.jpg")
```
...
```{r}
#| fig-align: center
include_graphics("img/github-classroom.jpg")
```
